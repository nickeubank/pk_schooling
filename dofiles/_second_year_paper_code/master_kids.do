		...
		* Big sample	
			...
			eststo: xi: reg child_`x'_theta school_private filler interact_zaat_private  ///
				...
				eststo: xi: reg child_`x'_theta school_private mauza_zaat_frac interact_zaat_private  ///
					...
					graph save $pk/docs/graphs/kids_`x'_district.gph, replace
		...
		esttab  using $pk/docs/regressions/children.tex, b(a2) replace nogaps compress label booktabs noconstant ///
...
graph combine ///
	$pk/docs/graphs/kids_english.gph ///
	 $pk/docs/graphs/kids_urdu.gph ///
	  $pk/docs/graphs/kids_math.gph, row(1) ///
...
graph export $pk/docs/graphs/kids_combined.pdf, replace

graph combine ///
	$pk/docs/graphs/kids_english_district.gph ///
	 $pk/docs/graphs/kids_urdu_district.gph ///
	  $pk/docs/graphs/kids_math_district.gph, row(1) ///
	title(Caste Fractionalization and Value Added Scores) subtitle(With 90 Percent Confidence Intervals) ///
	note("Controls include village fixed effects, gender, age, age squared, child wealth and parental education")
graph export $pk/docs/graphs/kids_combined_district.pdf, replace
	...
	foreach x in english urdu math {
		...
		* Big sample	
			...
			eststo: xi: reg child_`x'_theta school_private mauza_zaat_frac  ///
				...
				interact mauza_zaat_frac " " "`upper_x'"
				graph save $pk/docs/graphs/nointeract_`x'.gph, replace
}


		esttab  using $pk/docs/regressions/children_nointeract.tex, b(a2) replace nogaps compress label booktabs noconstant ///
			...
			graph combine ///
				$pk/docs/graphs/nointeract_english.gph ///
				 $pk/docs/graphs/nointeract_urdu.gph ///
				  $pk/docs/graphs/nointeract_math.gph, row(1) ///
				title(Caste Fractionalization and Value Added Scores) subtitle(With 90 Percent Confidence Intervals) ///
				note("Controls include village fixed effects, gender, age, age squared, child wealth and parental education")
			graph export $pk/docs/graphs/nointeraction_combined.pdf, replace
...
esttab  using $pk/docs/regressions/children_quantile_`x'.tex, b(a2) replace nogaps compress label booktabs noconstant ///
