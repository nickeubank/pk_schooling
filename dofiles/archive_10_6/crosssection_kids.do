	...
	* *********
	...
	restore
		...
		* *********
		...
		graph export $datadir/constructed/ethnic_info/docs/graphs/wealth_and_type.pdf, replace
...
preserve
	...
	* Do twice
	eststo:	xi: reg child_`x'_theta school_private  interact_zaat_private ///
		...
		graph save $datadir/constructed/ethnic_info/docs/graphs/privatepremium_g3_bigsample_`x'.gph, replace
	...
	xi: areg child_`x'_theta school_private mauza_zaat_frac interact_zaat_private ///
		...
		graph save $datadir/constructed/ethnic_info/docs/graphs/privatepremium_g3_smallsample_`x'.gph, replace

		graph combine ///
			$datadir/constructed/ethnic_info/docs/graphs/privatepremium_g3_bigsample_`x'.gph $datadir/constructed/ethnic_info/docs/graphs/privatepremium_g3_smallsample_`x'.gph , ///
		...
		graph export $datadir/constructed/ethnic_info/docs/graphs/privatepremium_`x'_crosssection.pdf, replace
...
esttab  using $datadir/constructed/ethnic_info/docs/regressions/privatepremium_crossection.tex, b(a2) replace nogaps compress label booktabs noconstant ///
...
local upper_x=proper("`x'")
		...
		* Do twice with no lag (for control) -- one for interact, one for outreg. 
		...
		xi: areg child_`x'_theta L.school_private L.mauza_zaat_frac L.interact_zaat_private ///
			...
			graph save $datadir/constructed/ethnic_info/docs/graphs/twoyear_nolag_`x'.gph, replace
		...
		* Do twice with lag, big sample. Once for interact, one for outreg. 
		...
		xi: areg child_`x'_theta L.school_private L.mauza_zaat_frac L.interact_zaat_private ///
			...
			graph save $datadir/constructed/ethnic_info/docs/graphs/twoyear_big_`x'.gph, replace
		...
		graph save $datadir/constructed/ethnic_info/docs/graphs/twoyear_small_`x'.gph, replace



		graph combine ///
			$datadir/constructed/ethnic_info/docs/graphs/twoyear_nolag_`x'.gph  $datadir/constructed/ethnic_info/docs/graphs/twoyear_big_`x'.gph ///
			  $datadir/constructed/ethnic_info/docs/graphs/twoyear_small_`x'.gph, row(1) ///
		...
		graph export $datadir/constructed/ethnic_info/docs/graphs/twoyear_`x'.pdf, replace


	}

		esttab  using $datadir/constructed/ethnic_info/docs/regressions/twoyear.tex, b(a2) replace nogaps compress label booktabs noconstant ///
...
esttab  using $datadir/constructed/ethnic_info/docs/regressions/separate_drivers.tex, b(a2) replace nogaps compress label booktabs noconstant ///
