...
keep if _m==3
	...
	* School top two
	...
	graph export $datadir/constructed/ethnic_info/docs/graphs/school_toptwo.pdf, replace


	* Village
	egen mtag=tag(mauzaid)
	replace mauza_share_in_toptwo=mauza_share_in_toptwo*100
	...
	graph export $datadir/constructed/ethnic_info/docs/graphs/village_toptwo.pdf, replace
qqq
	...
	graph export $datadir/constructed/ethnic_info/docs/graphs/totalpresent.pdf, replace

	graph combine `village_toptwo'.gph `toptwo'.gph , title(Top Two Caste Shares) rows(1)
	graph export $datadir/constructed/ethnic_info/docs/graphs/toptwo_combined.pdf, replace
