...
/*
	esttab  using $datadir/constructed/ethnic_info/docs/regressions/valueadded_frac.tex, b(a2) replace nogaps compress label booktabs noconstant ///
...
gen ln_numhh=ln(M_numhh)
		...
		graph combine `dist_1_english'.gph `dist_2_english'.gph `dist_3_english'.gph  `dist_all_english'.gph  ///
					...
					,rows(3) cols(4)
		graph export  $datadir/constructed/ethnic_info/docs/graphs/valueadded_all_pweighted.pdf, replace
...
graph combine `dist_all_english'.gph  ///
			...
			`dist_all_math'.gph ///
			,rows(3) cols(4)
graph export  $datadir/constructed/ethnic_info/docs/graphs/valueadded_all_lfit.pdf, replace
