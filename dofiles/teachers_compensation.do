...
esttab  using $datadir/constructed/ethnic_info/docs/regressions/teachercompensation.tex, b(a2) replace nogaps compress label booktabs noconstant ///
...
* preserve 
	...
	foreach x in  english math urdu{
		...
		graph save $datadir/constructed/ethnic_info/docs/graphs/valueadded_`x'.gph, replace
...
qqq
		...
		graph combine ///
			$datadir/constructed/ethnic_info/docs/graphs/valueadded_english.gph  $datadir/constructed/ethnic_info/docs/graphs/valueadded_math.gph ///
			  $datadir/constructed/ethnic_info/docs/graphs/valueadded_urdu.gph, rows(1) ///
		...
		graph export $datadir/constructed/ethnic_info/docs/graphs/valueadded.pdf, replace
