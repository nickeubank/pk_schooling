...
twoway(kdensity mauza_zaat_frac if district==1 ) ///
	...
	graph export $datadir/constructed/ethnic_info/docs/graphs/village_frac_by_district.pdf, replace
...
esttab  using $datadir/constructed/ethnic_info/docs/regressions/village_by_frac.tex, b(a2) replace nogaps compress label noconstant booktabs ///
...
outtable using $datadir/constructed/ethnic_info/docs/tables/village_summary, mat(results)  replace clabel(vsummary) format(%9.2g) caption(Village Summary Statistics) 
...
outtable using $datadir/constructed/ethnic_info/docs/tables/village_summary_demeaned, mat(results) caption("Summary Statistics, After Subracting District Averages") replace clabel(vsummarydemeaned) format(%9.2g) 
