...
preserve
	...
	* Do twice
	...
	graph save $datadir/constructed/ethnic_info/docs/graphs/g3_bigsample_`x'.gph, replace
	...
	graph save $datadir/constructed/ethnic_info/docs/graphs/g3_smallsample_`x'.gph, replace



		graph combine ///
			$datadir/constructed/ethnic_info/docs/graphs/g3_bigsample_`x'.gph $datadir/constructed/ethnic_info/docs/graphs/g3_smallsample_`x'.gph , ///
		...
		graph export $datadir/constructed/ethnic_info/docs/graphs/crosssection_`x'.pdf, replace
	}
