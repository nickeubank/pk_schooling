...
keep if _m==3
	...
	* School top two
	...
	graph export $pk/docs/results/school_toptwo.pdf, replace
	...
	* Village
	...
	graph export $pk/docs/results/village_toptwo.pdf, replace
	...
	graph export $pk/docs/results/totalpresent.pdf, replace

	graph combine `village_toptwo'.gph `toptwo'.gph , title(Top Two Caste Shares) rows(1)
	graph export $pk/docs/results/toptwo_combined.pdf, replace
