...
use $pk/leaps_data/village_preconstructed_variables, clear
drop M_frac_zaat
...
esttab  using $pk/docs/regressions/village_by_frac.tex, b(a2) replace nogaps compress label noconstant booktabs ///
