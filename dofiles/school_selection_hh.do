...
keep hhid mauzaid total_expend hm1_s0q8_zaatcode
sort hhid 
tempfile hh
save `hh', replace
...
* Member vars
use $datadir/household/hhsurvey1/hhsurvey1_member, clear
...
* Get kids
use $datadir/household/hhsurvey1/hhsurvey1_child, clear
...
esttab  using $datadir/constructed/ethnic_info/docs/regressions/hhselection.tex, b(a2) replace nogaps compress label noconstant 	title(School Choice and Child Intelligence\label{hhselection}) ///
...
esttab  using $datadir/constructed/ethnic_info/docs/regressions/hhselection_interaction.tex, b(a2) replace nogaps compress label noconstant 	title(School Choice and Child Intelligence\label{hhselectioninteraction}) ///
...
xi:areg school_private i.status_b*mauza_zaat_frac ln_expend mom_haseduc dad_haseduc age age2 female above M_wealth ln_hh [pw=hh_weight] , cluster(mauzaid) a(mauzaid)

* Significant, but backwards! High status tend towards government?
