...
use $pk/constructed_data/custom_child_panel, clear
	...
	foreach x in english urdu math {
		...
		* Big sample
			...
			* has hhid, merged, has lagged scores available, caste was known to be high or low
			assert `e(N)' > 1700 
			...
			* has hhid, merged, has lagged scores available, caste was known to be high or low, and PCA index
			assert `e(N)' > 1300 
		...
		esttab  using $pk/docs/results/status.tex, b(a2)  se replace nogaps compress label booktabs noconstant ///
