...
esttab  using $pk/docs/regressions/hhselection.tex, b(a2) replace nogaps compress label noconstant 	title(School Choice and Child Intelligence\label{hhselection}) ///
...
esttab  using $pk/docs/regressions/hhselection_interaction.tex, b(a2) replace nogaps compress label noconstant 	title(School Choice and Child Intelligence\label{hhselectioninteraction}) ///
