...
drop _m
	...
	foreach x in  english math urdu{
		eststo:	xi: reg valueadded_`x' i.reportcard*mauza_zaat_frac M_wealth M_literacy M_gini_land i.district [pw=num_students] , cluster(mauzaid) 
		eststo:	xi: reg valueadded_`x' i.reportcard*mauza_zaat_frac M_wealth M_literacy M_gini_land i.district [pw=num_students] if school_private==1 , cluster(mauzaid) 
		eststo:	xi: reg valueadded_`x' i.reportcard*mauza_zaat_frac M_wealth M_literacy M_gini_land i.district [pw=num_students] if school_private==0 , cluster(mauzaid) 
